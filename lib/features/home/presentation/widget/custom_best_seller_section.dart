...
import 'package:ecommerce_app/features/home/presentation/widget/best_seller_section_loading.dart';
            ...
            children: [
              ...
              Center(
                child: Text(
                  state.errMessage,
                  style: TextStyleManager.meduim(
                      size: TextSizeManager.s17, color: ColorManager.redColor),
                ),
              ),
            ],
          );
